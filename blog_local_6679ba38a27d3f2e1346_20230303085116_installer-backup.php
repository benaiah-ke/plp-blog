...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'blog_local_6679ba38a27d3f2e1346_20230303085116_archive.zip';
        const ARCHIVE_SIZE       = '130501389';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '6679ba3-03085116';
        const SECONDARY_PACKAGE_HASH = '5b9026a-03085116';
